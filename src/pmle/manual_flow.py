...
SETUP_PROMPT = (
    ...
    "- meeting title\n"
    "- decision owner\n"
    "- participants and roles — *@mention each teammate with their role* "
    "(Growth / Commerce / Lead) and I'll DM them for input; or list plain names to voice them yourself\n"
